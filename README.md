...
- local signer-backed Hyperliquid action signing, supervised submit artifacts, canonical submit sessions, direct post-submit status, richer fill/close reconciliation, and a first supervised cancel boundary now exist, while continuous-supervision work still remains future work
